 ...
 * 
 */
@WebServiceClient(name = "WebServiceImplService", targetNamespace = "http://impl.service.hbaseWebService.dingjiacheng.xyz/", wsdlLocation = "http://192.168.43.154:8081/wsServeice?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEBSERVICEIMPLSERVICE_QNAME = new QName("http://impl.service.hbaseWebService.dingjiacheng.xyz/", "WebServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://192.168.43.154:8081/wsServeice?wsdl");
    ...
    public WebServiceImpl getWebServiceImplPort() {
        return super.getPort(new QName("http://impl.service.hbaseWebService.dingjiacheng.xyz/", "WebServiceImplPort"), WebServiceImpl.class);
    }
    ...
    public WebServiceImpl getWebServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.service.hbaseWebService.dingjiacheng.xyz/", "WebServiceImplPort"), WebServiceImpl.class, features);
    }
