 ...
 * 
 */
@WebServiceClient(name = "WebServiceImplService", targetNamespace = "http://impl.service.writeAndReadDataToKafka.dingjiacheng.xyz/", wsdlLocation = "http://192.168.1.100:8083/kafka?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEBSERVICEIMPLSERVICE_QNAME = new QName("http://impl.service.writeAndReadDataToKafka.dingjiacheng.xyz/", "WebServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://192.168.1.100:8083/kafka?wsdl");
    ...
    public WebServiceImpl getWebServiceImplPort() {
        return super.getPort(new QName("http://impl.service.writeAndReadDataToKafka.dingjiacheng.xyz/", "WebServiceImplPort"), WebServiceImpl.class);
    }
    ...
    public WebServiceImpl getWebServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.service.writeAndReadDataToKafka.dingjiacheng.xyz/", "WebServiceImplPort"), WebServiceImpl.class, features);
    }
