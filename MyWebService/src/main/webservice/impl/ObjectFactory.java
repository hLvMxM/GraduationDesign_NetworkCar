...
public class ObjectFactory {
    ...
    private final static QName _GetPositionResponse_QNAME = new QName("http://impl.WebService/", "getPositionResponse");
    private final static QName _GetPosition_QNAME = new QName("http://impl.WebService/", "getPosition");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://impl.WebService/", name = "getPositionResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://impl.WebService/", name = "getPosition")
